...
export class Backend implements backendInterface {
    ...
    async filterRestaurants(arg0: string, arg1: number): Promise<Array<Restaurant>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterRestaurants(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getFavoriteRestaurants(): Promise<Array<Restaurant>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFavoriteRestaurants();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
